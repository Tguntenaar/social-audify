...
<body>
  ...
  <div class="client-dashboard content-right y-scroll col-xs-12 col-sm-12 col-md-12 col-lg-9" style="padding-bottom: 50px;">
      ...
      <div class="client-overview">
          ...
          ?>
          <div class="client-overview-row">
              <div class="client-overview-row-inner" data-id="<?php echo $client->id; ?>" data-client="<?php echo htmlentities(json_encode($data)); ?>">
                  <?php if($audit_send) { ?>
          ...
          <!-- <div class="client-overview-row">
              <div class="client-overview-row-inner">
                <div class="client-status in_progress">In progress</div>
                <div class="details">
                      <span class="client-name-n">Hoogenkamp Makelaars</span>
                      <a class="social-icon" href="#"><i class="fab fa-facebook-f"></i></a>
                      <a class="social-icon instagram-social" href="#"><i class="fab fa-instagram"></i></a>
                      <a class="social-icon web-social" href="#"><i class="fas fa-globe"></i></a>
                      <a class="social-icon instagram-social mail-social"  href="#"><i class="far fa-envelope"></i></a>
                </div>
                <div class="audit-status">Audit opened 30 days ago</div>
                <i class="fas fa-ellipsis-v edit-client"></i>
              </div>
          </div>

          <div class="client-overview-row">
              <div class="client-overview-row-inner">
                <div class="client-status no_reply">No reply</div>
                <div class="details">
                      <span class="client-name-n">Mooi ben Jij!</span>
                      <a class="social-icon" href="#"><i class="fab fa-facebook-f"></i></a>
                      <a class="social-icon instagram-social" href="#"><i class="fab fa-instagram"></i></a>
                      <a class="social-icon web-social" href="#"><i class="fas fa-globe"></i></a>
                      <a class="social-icon instagram-social mail-social"  href="#"><i class="far fa-envelope"></i></a>
                  ...
                  <div class="audit-status">Audit send</div>
                  <i class="fas fa-ellipsis-v edit-client"></i>
              </div>
          </div>
          <div class="client-overview-row">
              <div class="client-overview-row-inner">
                  <div class="client-status converted">Converted</div>
                  <div class="details">
                      <span class="client-name-n">Space X</span>
                      <a class="social-icon instagram-social" href="#"><i class="fab fa-instagram"></i></a>
                      <a class="social-icon web-social" href="#"><i class="fas fa-globe"></i></a>
                      <a class="social-icon instagram-social mail-social"  href="#"><i class="far fa-envelope"></i></a>
                  </div>
          ...
          <div class="client-overview-row">
              ...
              <div class="client-status converted">Converted</div>
              <div class="details">
                      <span class="client-name-n">Tesla</span>
                      <a class="social-icon" href="#"><i class="fab fa-facebook-f"></i></a>
                      <a class="social-icon instagram-social" href="#"><i class="fab fa-instagram"></i></a>
                      <a class="social-icon instagram-social mail-social"  href="#"><i class="far fa-envelope"></i></a>
          ...
          <div class="client-overview-row">
              <div class="client-overview-row-inner">
                <div class="client-status no_reply">No reply</div>
                <div class="details">
                      <span class="client-name-n">Instagram</span>
                      <a class="social-icon" href="#"><i class="fab fa-facebook-f"></i></a>
                      <a class="social-icon instagram-social" href="#"><i class="fab fa-instagram"></i></a>
                      <a class="social-icon web-social" href="#"><i class="fas fa-globe"></i></a>
                      <a class="social-icon instagram-social mail-social"  href="#"><i class="far fa-envelope"></i></a>
          ...
          <div class="client-overview-row">
              <div class="client-overview-row-inner">
                <div class="client-status no_reply">No reply</div>
                <div class="details">
                      <span class="client-name-n">Facebook</span>
                      <a class="social-icon" href="#"><i class="fab fa-facebook-f"></i></a>
                      <a class="social-icon instagram-social" href="#"><i class="fab fa-instagram"></i></a>
                      <a class="social-icon web-social" href="#"><i class="fas fa-globe"></i></a>
                      <a class="social-icon instagram-social mail-social"  href="#"><i class="far fa-envelope"></i></a>
          ...
          <div class="client-overview-row">
              <div class="client-overview-row-inner">
                <div class="client-status no_reply">No reply</div>
                <div class="details">
                      <span class="client-name-n">Google</span>
                      <a class="social-icon" href="#"><i class="fab fa-facebook-f"></i></a>
                      <a class="social-icon instagram-social" href="#"><i class="fab fa-instagram"></i></a>
                      <a class="social-icon web-social" href="#"><i class="fas fa-globe"></i></a>
                      <a class="social-icon instagram-social mail-social"  href="#"><i class="far fa-envelope"></i></a>
