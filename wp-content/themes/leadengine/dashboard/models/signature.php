...
class signature
{
  ...
  {
  ?>
    <table style="width: 525px" cellSpacing="0" cellPadding="0">
      <tbody>
        <tr>
          <td style="font-size: 10pt; font-family: Arial; width: 125px" vAlign="middle">
            <img src=<?php echo $this->img_url ?> alt="Signature" width="250" id="signature-img">
          </td>
          <td
            style="font-size: 10pt; font-family: Arial; width: 400px; padding-left: 20px; border-left: <?php echo $this->color ?> 1px solid"
            vAlign="top">
            <strong style="font-size: 11pt">
              ...
              <span style="color: <?php echo $this->color ?>"><strong>e:</strong></span>
              <a style="color: #000000"><?php echo $this->email?></a> |
