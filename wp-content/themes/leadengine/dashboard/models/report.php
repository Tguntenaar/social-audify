...
class report {
  ...
  public function insert_data($social_stats, $chart_data, $competitor = 0, $manual) {
    if ($competitor == 0) {
      $this->sql_data->social_stats = $social_stats;
      $this->sql_data->chart_data = $chart_data;
      return $this->service->insert_data($this->id, $social_stats, $chart_data, $competitor, $manual);
    }
