...
<form id="rcp_password_form"  class="rcp_form" method="POST" action="<?php echo esc_url( rcp_get_current_url() ); ?>">
	<fieldset class="rcp_change_password_fieldset">
		...
		<p style="margin-top: -40px;">
			...
			<input id="rcp_password_submit" class="rcp-button" style="float: left; height: 40px;background: #2980b9;color: #fff;text-align: center;line-height: 30px;border: 0;" type="submit" value="<?php esc_attr_e( apply_filters( 'rcp_registration_change_password_button', __( 'Change Password', 'rcp' ) ) ); ?>"/>
		</p>
	</fieldset>
</form>
