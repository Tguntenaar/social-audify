...
<div class="wrap wpsu">
  ...
  <div class="head_area">
	<h2><span class="dashicons dashicons-welcome-widgets-menus"></span> WP-SpeedUp - <?php echo __('Settings', 'wp-speedup'); ?></h2>
  </div>
  
  
  <a data-mode="booster" class="wpsu_modes button-secondary button-large">DB <?php echo __('Booster', 'wp-speedup'); ?></a>
  <a data-mode="advanced" class="wpsu_modes button-secondary button-large"><?php echo __('Caching Mode', 'wp-speedup'); ?></a>  
  <a data-mode="classic" class="wpsu_modes button-secondary button-large"><?php echo __('Image Optimization', 'wp-speedup'); ?></a>
  <br />
<br />
...
<?php wp_nonce_field( 'wpsu_nonce_action3', 'wpsu_nonce_action3_field' ); ?>     
	...
	<div class="wpsu_booster_wrapper">
    	...
    	<table>
        	<tr>
            	<td><h2><?php echo __('What is', 'wp-speedup'); ?> InnoDB?</h2>
        <p>
...
<input type="submit" value="Convert all MyISAM to InnoDB" class="button-secondary button-large" name="itom_conversion_innodb" /></td>
                <td><h2><?php echo __('What is', 'wp-speedup'); ?> MyISAM?</h2>
        <p>
