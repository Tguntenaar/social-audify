...
function wpua_do_before_avatar() {
	$wpua_profile_title = '<h3>' . esc_html__( 'Avatar', 'wp-user-avatar-pro' ) . '</h3>';
	/**
	...
	*/
	...
	<h2 class="entry-title"><?php esc_html_e( 'Avatar', 'wp-user-avatar-pro' ); ?></h2>
	<fieldset class="bbp-form">
	  <legend><?php esc_html_e( 'Image', 'wp-user-avatar-pro' ); ?></legend>
	<?php elseif ( class_exists( 'WPUF_Main' ) && wpuf_has_shortcode( 'wpuf_editprofile' ) ) : // Add to WP User Frontend profile with same style ?>
	<fieldset>
	  <legend><?php esc_html_e( 'Avatar', 'wp-user-avatar-pro' ); ?></legend>
	  <table class="wpuf-table">
		<tr>
		  <th><label for="wp_user_avatar"><?php esc_html_e( 'Image', 'wp-user-avatar-pro' ); ?></label></th>
		  <td>
	<?php else : // Add to profile without table ?>
	<div class="wpua-edit-container">
		<?php echo wp_kses_post( $wpua_profile_title ); ?>
	<?php endif; ?>
	<?php
}
...
function wpua_do_before_avatar_admin() {
	?>
  <h3><?php esc_html_e( 'Avatar', 'wp-user-avatar-pro' ); ?></h3>
...
function wpua_do_donation_message() {
	?>
   <div class="updated">
	<p><?php esc_html_e( 'Do you like WP User Avatar?', 'wp-user-avatar-pro' ); ?> <a href="http://wordpress.org/plugins/wp-google-map-plugin/" target="_blank"><?php esc_html_e( 'Try our Google Maps Plugin.', 'wp-user-avatar-pro' ); ?></a></p> 
  </div>
	<?php
}
