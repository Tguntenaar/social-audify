...
class AuthV4Query extends Signer implements Signable {
	...
	protected static $endpoint_map = array(
		...
		'email.us-east-1.amazonaws.com'      => array(
			'service' => 'ses',
			'region' => 'us-east-1',
		),

		// Amazon Simple Queue Service (SQS)
		'queue.amazonaws.com'                => array(
			'service' => 'sqs',
			'region' => 'us-east-1',
		),
		'us-west-1.queue.amazonaws.com'      => array(
			'service' => 'sqs',
			'region' => 'us-west-1',
		),
		'us-west-2.queue.amazonaws.com'      => array(
			'service' => 'sqs',
			'region' => 'us-west-2',
		),
		'eu-west-1.queue.amazonaws.com'      => array(
			'service' => 'sqs',
			'region' => 'eu-west-1',
		),
		'ap-southeast-1.queue.amazonaws.com' => array(
			'service' => 'sqs',
			'region' => 'ap-southeast-1',
		),
		'ap-southeast-2.queue.amazonaws.com' => array(
			'service' => 'sqs',
			'region' => 'ap-southeast-2',
		),
		'ap-northeast-1.queue.amazonaws.com' => array(
			'service' => 'sqs',
			'region' => 'ap-northeast-1',
		),
		'sa-east-1.queue.amazonaws.com'      => array(
			'service' => 'sqs',
			'region' => 'sa-east-1',
		),
		'us-gov-west-1.queue.amazonaws.com'  => array(
			'service' => 'sqs',
